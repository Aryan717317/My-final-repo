...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative min-h-screen py-24 px-6 md:px-12 w-full max-w-[1600px] mx-auto z-20 flex flex-col justify-center overflow-hidden bg-[#09090B]">
      ...
      <AnimatePresence>
        {transitioning && (
          <motion.div
            ...
            className="fixed inset-0 bg-gradient-to-r from-[#8B5CF6] via-[#6366F1] to-[#F59E0B] z-50 pointer-events-none"
          />
        )}
      </AnimatePresence>
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <AnimatePresence mode="wait">
          {activeStep && (
            ...
            >
              {/* Backlight glow */}
              <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#8B5CF6]/15 rounded-full blur-[120px] pointer-events-none" />
              ...
              <div className="flex justify-between items-center w-full mb-8 relative z-10">
                ...
                <span className="text-xs font-mono text-[#8B5CF6] tracking-[0.2em] uppercase font-bold">
              ...
              <div className="my-auto relative z-10 flex flex-col items-center text-center">
                ...
                {activeStep === 'message' ? (
                  <textarea
                    ...
                    className="w-full max-w-2xl bg-transparent border-b-2 border-white/10 focus:border-[#8B5CF6] py-4 text-center text-xl md:text-2xl text-white outline-none placeholder-white/15 transition-colors duration-300 resize-none min-h-[120px]"
                  />
                ) : (
                  <input
                    ...
                    className="w-full max-w-xl bg-transparent border-b-2 border-white/10 focus:border-[#8B5CF6] py-4 text-center text-xl md:text-2xl text-white outline-none placeholder-white/15 transition-colors duration-300"
                    onKeyDown={(e) => {
                ...
                <div className="flex items-center gap-4">
                  {activeStep !== 'message' ? (
                    <button
                      ...
                      className="px-6 py-3 rounded-full bg-white text-black font-sans font-bold text-xs tracking-wider uppercase transition-all duration-300 hover:bg-[#8B5CF6] hover:text-white disabled:opacity-40 disabled:hover:bg-white disabled:hover:text-black flex items-center gap-2 shadow-lg"
                    >
                      <span>Continue</span>
            ...
            >
              ...
              <div className="text-center mb-16 max-w-2xl">
                <motion.span
                  ...
                  viewport={{ once: true }}
                  className="text-xs md:text-sm font-mono tracking-[0.3em] uppercase mb-4 text-[#8B5CF6] block font-bold"
                >
                  [ LET'S CONNECT ]
                </motion.span>
                <motion.h2
              ...
              <div className="w-full max-w-5xl bg-[#0c0e15]/40 border border-white/[0.08] backdrop-blur-2xl rounded-[3rem] p-8 md:p-16 flex flex-col items-center shadow-[0_50px_100px_rgba(0,0,0,0.8)] relative overflow-hidden mb-8">
                ...
                <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#8B5CF6]/10 rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 w-full justify-items-center relative z-10">
                  ...
                  <motion.div
                    ...
                    className={`relative w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] rounded-full border flex flex-col items-center justify-center p-6 text-center cursor-pointer transition-all duration-500 overflow-hidden select-none ${
                      name 
                        ? 'bg-white/[0.04] border-[#8B5CF6]/40 shadow-[0_0_30px_rgba(139,92,246,0.1)]' 
                  ...
                  >
                    ...
                    {name ? (
                      ...
                      <span className="text-[10px] font-mono text-[#8B5CF6]/60 uppercase tracking-widest mt-1">
                        [ Click to fill ]
                      </span>
                    )}
          ...
          {submitted && (
            ...
            >
              <div className="w-20 h-20 rounded-full bg-[#8B5CF6]/10 border border-[#8B5CF6]/30 flex items-center justify-center mb-6">
