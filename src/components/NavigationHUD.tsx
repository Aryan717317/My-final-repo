        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Hover highlight dot */}
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-[#8B5CF6] opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />

              <span className={`transition-transform duration-300 ${isActive ? 'text-[#8B5CF6] scale-110' : 'text-[#A1A1AA]'}`}>
                {item.icon}
              </span>
